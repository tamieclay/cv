"""
Django settings for curra project.
...
WSGI_APPLICATION = 'curra.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'home' / 'static',  # Add the app-level static folder for 'home'
    # Add other app-level static folders if present
]
